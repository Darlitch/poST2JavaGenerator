...
public class PoSTParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PoSTGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getStatementAccess().getGroup_9(), "rule__Statement__Group_9__0");
			builder.put(grammarAccess.getInline_codeAccess().getGroup(), "rule__Inline_code__Group__0");
			...
			builder.put(grammarAccess.getModelAccess().getConfAssignment_1(), "rule__Model__ConfAssignment_1");
			builder.put(grammarAccess.getModelAccess().getGlobVarsAssignment_2(), "rule__Model__GlobVarsAssignment_2");
			builder.put(grammarAccess.getModelAccess().getProgramsAssignment_3(), "rule__Model__ProgramsAssignment_3");
			builder.put(grammarAccess.getModelAccess().getFbsAssignment_4(), "rule__Model__FbsAssignment_4");
			builder.put(grammarAccess.getModelAccess().getFunsAssignment_5(), "rule__Model__FunsAssignment_5");
			...
			builder.put(grammarAccess.getInline_codeAccess().getInline_codeAssignment_1(), "rule__Inline_code__Inline_codeAssignment_1");
