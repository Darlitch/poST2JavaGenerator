...
public class Simulation implements ISimulationRuntime {
    ...
    public Simulation() {
        ...
        Controller.LightProcess red_light1 = new Controller.LightProcess("red_light1", memory, red_light1_aliases, processMap);
        ...
        Controller.LightProcess yellow_light1 = new Controller.LightProcess("yellow_light1", memory, yellow_light1_aliases, processMap);
        ...
        Controller.LightProcess green_light1 = new Controller.LightProcess("green_light1", memory, green_light1_aliases, processMap);
        ...
        Controller.LightProcess red_light2 = new Controller.LightProcess("red_light2", memory, red_light2_aliases, processMap);
        ...
        Controller.LightProcess yellow_light2 = new Controller.LightProcess("yellow_light2", memory, yellow_light2_aliases, processMap);
        ...
        Controller.ControlProcess control2 = new Controller.ControlProcess("control2", memory, control2_aliases, processMap);
