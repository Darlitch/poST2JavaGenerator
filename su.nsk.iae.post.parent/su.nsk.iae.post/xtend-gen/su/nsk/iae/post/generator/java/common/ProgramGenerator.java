...
public class ProgramGenerator {
  ...
  public String generate(final Program program, final GenerationContext ctx) {
    String _xblockexpression = null;
    {
      ...
      _builder_1.append("private Object getArrayValue(String name, int index, int start) {");
      _builder_1.newLineIfNotEmpty();
      _builder_1.append(ProgramGenerator.INDENT);
      _builder_1.append("    java.util.List<String> list =");
      _builder_1.newLineIfNotEmpty();
      _builder_1.append(ProgramGenerator.INDENT);
      _builder_1.append("        (java.util.List<String>) memory.get(name);");
      _builder_1.newLineIfNotEmpty();
      _builder_1.newLine();
      _builder_1.append(ProgramGenerator.INDENT);
      _builder_1.append("    int offset = index - start;");
      _builder_1.newLineIfNotEmpty();
      _builder_1.newLine();
      _builder_1.append(ProgramGenerator.INDENT);
      _builder_1.append("    if (offset < 0 || offset >= list.size()) {");
      _builder_1.newLineIfNotEmpty();
      _builder_1.append(ProgramGenerator.INDENT);
      _builder_1.append("        throw new RuntimeException(");
      _builder_1.newLineIfNotEmpty();
      _builder_1.append(ProgramGenerator.INDENT);
      _builder_1.append("            \"Array index out of bounds: \" + name + \"[\" + index + \"]\"");
      _builder_1.newLineIfNotEmpty();
      _builder_1.append(ProgramGenerator.INDENT);
      _builder_1.append("        );");
      _builder_1.newLineIfNotEmpty();
      ...
      _builder_1.newLine();
      _builder_1.append(ProgramGenerator.INDENT);
      _builder_1.append("    String cell = list.get(offset);");
      _builder_1.newLineIfNotEmpty();
      _builder_1.append(ProgramGenerator.INDENT);
      _builder_1.append("    return memory.get(cell);");
      _builder_1.newLineIfNotEmpty();
      _builder_1.append(ProgramGenerator.INDENT);
      _builder_1.append("}");
      _builder_1.newLineIfNotEmpty();
      _builder_1.newLine();
      _builder_1.append(ProgramGenerator.INDENT);
      _builder_1.append("private void setArrayValue(String name, int index, int start, Object value) {");
      _builder_1.newLineIfNotEmpty();
      _builder_1.append(ProgramGenerator.INDENT);
      _builder_1.append("    java.util.List<String> list =");
      _builder_1.newLineIfNotEmpty();
      ...
      _builder_1.newLineIfNotEmpty();
      _builder_1.append(ProgramGenerator.INDENT);
      _builder_1.append("    memory.put(cell, value);");
      _builder_1.newLineIfNotEmpty();
      _builder_1.append(ProgramGenerator.INDENT);
      _builder_1.append("}");
      _builder_1.newLineIfNotEmpty();
