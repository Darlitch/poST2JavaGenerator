...
public class RepeatStatementGenerator implements IStatementGenerator {
  private final StatementListGenerator stmtGen;

  public RepeatStatementGenerator(final StatementListGenerator stmtGen) {
    this.stmtGen = stmtGen;
  }

  @Override
  public boolean supports(final Statement stmt) {
    return (stmt instanceof RepeatStatement);
  }
  ...
  public String generate(final Statement stmt, final GenerationContext ctx, final String indent) {
    ...
    {
      final RepeatStatement s = ((RepeatStatement) stmt);
